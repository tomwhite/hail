...
object VariantEffectAnnotator extends DockerizedAnnotator {
  ...
  class Options extends DockerOptions {
    ...
    var vepConfig: String = System.getProperty("user.home")+"/.vep"
  ...
  override def getWorkhorse() = new Workhorse {
    ...
    override def readAnnotations(): Iterator[Map[String, String]] = {
      Source
          ...
          .map(_.toList.toMap) //TODO: Terrible hack to get a serializable map
    }
